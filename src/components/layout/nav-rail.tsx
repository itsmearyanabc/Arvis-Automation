      ...
      >
        ...
        <div className={`flex items-center shrink-0 ${sidebarExpanded ? 'px-3 py-3 gap-2.5' : 'flex-col py-3 gap-2'}`}>
          ...
          {sidebarExpanded && (
            <div className="flex items-baseline gap-2 truncate flex-1 min-w-0">
              <span className="text-sm font-semibold text-foreground truncate">Arvis</span>
        ...
        {sidebarExpanded && (
          <div className="px-2 pb-2 space-y-2 shrink-0">
            <div className="block rounded-lg border border-border/50 bg-surface-1 p-2">
              <div className="flex items-center gap-1.5 mb-0.5">
                <span className="text-2xs font-semibold text-foreground">AR MEDIAS</span>
                <span className="text-[9px] px-1 py-px rounded bg-primary/15 text-primary font-mono">OPS</span>
              </div>
              <p className="text-[10px] text-muted-foreground/70 leading-snug">Automated operations hub.</p>
            </div>
          </div>
        )}
        ...
        {sidebarExpanded && (
          <div className="px-3 pb-1">
            <p className="text-[10px] text-muted-foreground/30 text-center">
              Powered by{' '}
              <span className="text-muted-foreground/50">AR MEDIAS</span>
            </p>
          </div>
        )}
